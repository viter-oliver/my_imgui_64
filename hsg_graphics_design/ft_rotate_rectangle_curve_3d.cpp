#include "ft_rotate_rectangle_curve_3d.h"
...
void main()
{
    ...
    BgTextCoord = vec2(textCoord.x,textCoord.y + 0.8);
}
)glsl";
...
{
     ps_shader ft_rotate_rectangle_curve_3d::_phud_sd = nullptr;
     ps_primrive_object ft_rotate_rectangle_curve_3d::_ps_prm = nullptr;

     ft_rotate_rectangle_curve_3d::ft_rotate_rectangle_curve_3d()
     {
          /*if( !_phud_sd )
          {
        ...
        */
          ...
          _pt_tb._lane_bg_clr = {1.f,1.f,1.f};
     ...
     void ft_rotate_rectangle_curve_3d::link()
     {
          ...
          if( !ft_rotate_rectangle_curve_3d::_phud_sd )
          {
              ft_rotate_rectangle_curve_3d::_phud_sd = make_shared<af_shader>( sd_rt_curve_vs, sd_rt_curve_fs );
              ft_rotate_rectangle_curve_3d::_ps_prm = make_shared<primitive_object>();
              int demension = 5;
              ...
              ft_rotate_rectangle_curve_3d::_ps_prm->set_ele_format( { 3, 2 } );
              ft_rotate_rectangle_curve_3d::_ps_prm->load_vertex_data( vertices, data_cnt );
              delete[] vertices;
          }
     }

     void ft_rotate_rectangle_curve_3d::draw()
     {
