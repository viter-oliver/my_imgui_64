...
bool allow_add_item( string& parent_type_name, string& child_type_name )
{
     static multimap<string, string> dic_controls_child_control = {
        ...
        { "ft_light_scene", "ft_4_time_wall_3d" },
        { "ft_light_scene", "ft_obj_3d" },
        { "ft_trans", "ft_color_node" },
        {"ft_trans","ft_color_mesh"},
        {"ft_trans","ft_simple_mesh"},
        {"ft_trans","ft_1_texture_mesh"},
        {"ft_trans","ft_1_texture_node"},
        {"ft_trans","ft_rectangle_3d"},
        {"ft_trans","ft_rotate_curve_3d"},
        {"ft_trans","ft_rotate_rectangle_curve_3d"},
        {"ft_trans","ft_rotate_curl_curve_3d"},
        {"ft_trans","ft_rotate_twist_curve_3d"},
        {"ft_trans","ft_3_time_wall_3d"},
        {"ft_trans","ft_3_times_curve_3d"},
        {"ft_trans","ft_3_times_road_curve_3d"},
        {"ft_trans","ft_trans"},
