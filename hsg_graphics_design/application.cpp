...
namespace auto_future
{
    ...
    void application::create_distortion_screen()
    {
        _pscr_ds = make_shared<screen_image_distortion>(_win_width, _win_height, _screen_width, _screen_height, _arg_list[0]);
    }
