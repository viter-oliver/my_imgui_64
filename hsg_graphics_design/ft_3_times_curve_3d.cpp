...
{
     ps_shader ft_3_times_curve_3d::_phud_sd = nullptr;
     ps_primrive_object ft_3_times_curve_3d::_ps_prm = nullptr;

     ft_3_times_curve_3d::ft_3_times_curve_3d()
     {
          /*if( !_phud_sd )
          {
     ...
     void ft_3_times_curve_3d::link()
     {
          ...
          if( !ft_3_times_curve_3d::_phud_sd )
          {
              ft_3_times_curve_3d::_phud_sd = make_shared<af_shader>( sd_4_curve_vs, sd_4_curve_fs );
              ft_3_times_curve_3d::_ps_prm = make_shared<primitive_object>();
              int demension = 5;
              ...
              ft_3_times_curve_3d::_ps_prm->set_ele_format( { 3, 2 } );
              ft_3_times_curve_3d::_ps_prm->load_vertex_data( vertices, data_cnt );
              delete[] vertices;
          }
     }

     void ft_3_times_curve_3d::draw()
     {
          if( !_pat_image )
          {
               return;
