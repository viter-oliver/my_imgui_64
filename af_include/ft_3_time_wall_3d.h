...
{
	class AFG_EXPORT ft_3_time_wall_3d :
          public ft_base
     {
     ...
     public:
          ...
          ft_3_time_wall_3d& set_near(float fValue) {
              _pt_tb._near = fValue;
              return *this;
          }
          ft_3_time_wall_3d& set_far(float fValue) {
              _pt_tb._far = fValue;
              return *this;
          }
          ft_3_time_wall_3d& set_coeff( float cf0, float cf1, float cf2, float cf3 )
          {
          ...
          ft_3_time_wall_3d& set_base_z(float z) {
              _pt_tb._base_z = z;
              return *this;
          }

     };
     REGISTER_CONTROL( ft_3_time_wall_3d );
}
